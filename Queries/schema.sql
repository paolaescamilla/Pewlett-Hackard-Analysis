...
CREATE TABLE titles(emp_no INT NOT NULL, title INT NOT NULL, from_date DATE NOT NULL, to_date DATE NOT NULL,FOREIGN KEY(emp_no)REFERENCES EMPLOYEES(emp_no), PRIMARY KEY(emp_no, title, from_date));
